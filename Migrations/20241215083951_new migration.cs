        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessRequests_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BusinessRequests_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "RoleId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryRequests_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubCategoryRequests_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_BusinessServices_BusinessServicesID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favourites_BusinessServices_BusinessServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_BusinessServices_BusinessServiceId",
                        column: x => x.BusinessServiceId,
                        principalTable: "BusinessServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_BusinessServices_BusinessServiceId",
                        column: x => x.BusinessServiceId,
                        principalTable: "BusinessServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Technicians_BusinessServices_BusinessServiceId",
                        column: x => x.BusinessServiceId,
                        principalTable: "BusinessServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusinessNotifications_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BusinessNotifications_BusinessServices_BusinessServiceId",
                        column: x => x.BusinessServiceId,
                        principalTable: "BusinessServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessNotifications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BusinessServicesID",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessNotifications_AppointmentId",
                table: "BusinessNotifications",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessNotifications_BusinessServiceId",
                table: "BusinessNotifications",
                column: "BusinessServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessNotifications_UserId",
                table: "BusinessNotifications",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessRequests_AddressId",
                table: "BusinessRequests",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessRequests_RoleId",
                table: "BusinessRequests",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryRequests_BusinessId",
                table: "CategoryRequests",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_Favourites_BusinessServiceId",
                table: "Favourites",
                column: "BusinessServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_BusinessServiceId",
                table: "Images",
                column: "BusinessServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_BusinessServiceId",
                table: "Ratings",
                column: "BusinessServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_BusinessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryRequests_BusinessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Technicians_BusinessServiceId",
                table: "Technicians",
                column: "BusinessServiceId");
